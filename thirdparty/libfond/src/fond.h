...
// per fond_update.
FOND_EXPORT int fond_compute(struct fond_font *font, char *text, size_t *n,
                             unsigned int *vao);

// Same as fond_compute, but taking an UTF32
// encoded string of codepoints and its size.
FOND_EXPORT int fond_compute_u(struct fond_font *font, int32_t *text,
                               size_t size, size_t *n, unsigned int *vao);
...
// returns.
FOND_EXPORT int fond_update(struct fond_font *font, char *text, size_t *n,
                            unsigned int vbo, unsigned int ebo);

// Same as fond_update, but taking an UTF32
// encoded string of codepoints and its size.
FOND_EXPORT int fond_update_u(struct fond_font *font, int32_t *text,
                              size_t size, size_t *n, unsigned int vbo,
                              unsigned int ebo);

// Compute the extent of the given text.
// You must allocate the extent struct yourself
// and make sure it is zeroed out.
FOND_EXPORT int fond_compute_extent(struct fond_font *font, char *text,
                                    struct fond_extent *extent);

// Same as fond_compute_extent, but taking an
// UTF32 encoded string of codepoints and its
// size.
FOND_EXPORT int fond_compute_extent_u(struct fond_font *font, int32_t *text,
                                      size_t size, struct fond_extent *extent);
